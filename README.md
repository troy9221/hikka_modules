...
Коллекция модулей для [Hikka Userbot](https://github.com/hikariatama/Hikka).
...
| [**Sing**](README_MODULES/README_sing.md) | Народные песни текстом — правит одно сообщение строка за строкой | `.dlmod https://raw.githubusercontent.com/troy9221/hikka_modules/main/sing.py` |

## Установка

Отправьте боту Hikka команду `.dlmod` со ссылкой на нужный модуль из таблицы выше. Подробности по каждому модулю — в его отдельном README.
